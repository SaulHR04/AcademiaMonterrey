...
public class SecurityConfig {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(configurer -> configurer
                .requestMatchers(HttpMethod.GET,    "/api/Youtubers").hasRole("YOUTUBER")
                .requestMatchers(HttpMethod.GET,    "/api/Youtubers/**").hasRole("YOUTUBER")
                .requestMatchers(HttpMethod.POST,   "/api/Youtubers").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PUT,    "/api/Youtubers").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PATCH,  "/api/Youtubers/**").hasRole("MANAGER")
                .requestMatchers(HttpMethod.DELETE, "/api/Youtubers/**").hasRole("ADMIN")
